...
VARIABLES = {
    ...
    "SOLARA_SUGGESTION_RATE_LIMIT",
    "SOLARA_SUGGESTION_RATE_WINDOW_SECONDS",
    "SOLARA_SUGGESTION_BUDGET_LIMIT",
    "SOLARA_SUGGESTION_BUDGET_WINDOW_SECONDS",
    "SOLARA_SUGGESTION_CONCURRENCY_LIMIT",
    "SOLARA_DISCOVERY_BUDGET_LIMIT",
    "SOLARA_DISCOVERY_BUDGET_WINDOW_SECONDS",
    "PORT",
}
